...
class Person_Person(BaseModel):
    ...
    person_appellation_assertion: Annotated[
        list[AnyUrl], SPARQLBinding("person__person__person_appellation_assertion")
    ]
    ...
    birth_circumstances_claim: Annotated[
        AnyUrl, SPARQLBinding("person__person__birth_circumstances_claim")
    ]
    person_death_assertion: Annotated[
        AnyUrl, SPARQLBinding("person__person__person_death_assertion")
    ]
